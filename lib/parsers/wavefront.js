    ...
    let model = {
      ...
      const mapNewIndex = ( v, t, n) =>{
            if (!indexLookup.has(`${v}/${t}/${n}`)) {
              ...
              //how each elemenet is layedout i.e [ Vx,Vy,Vz, Nx,Ny,Nz, u0,v0]
              //Wavefront indices are arranged like V,T,N but we store them as V,N,T
              let elem = [...newV,...newNormal,...newUV];
