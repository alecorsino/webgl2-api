...
export class Model {
   ...
   */
  transform(rotationAxis, angle, position, scale) {// ERROR IN TRASNFORM  QUAT
    mat4.fromRotationTranslationScale(
      this.transMatrix,
      quat.setAxisAngle([1,1,1,1],rotationAxis,glMatrix.toRadian(angle)),
      position,
      scale );
  ...
  setupBuffers(gl = this.gl){
    ...
    this.vao = WebglDataBuffer.setupVAO(this.mesh, gl);	
